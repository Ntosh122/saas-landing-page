...
const TestimonialsColum = (props: {
  ...
  <div className={props.className}>
    <motion.div className="flex flex-col gap-6 pb-6" animate={{translateY:'-50%'}} transition={{repeat:Infinity,ease:'linear',repeatType:'loop',duration:props.duration||10}}>
    ...
    <section className="bg-white">
      <div className="container">
        <div className="section-heading">
          ...
          With its intuitive design and powerful features, our app has become an indispensable tool for users worldwide.
          </p>
        </div>
